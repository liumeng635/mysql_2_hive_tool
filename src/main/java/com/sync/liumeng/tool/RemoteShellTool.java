...
public class RemoteShellTool {
     ...
     private static String ipAddr = MonitorConfig.REMOTE_SSH_IP;
	 
     private static String userName = MonitorConfig.REMOTE_SSH_USER;  
     
     private static String password = MonitorConfig.REMOTE_SSH_PWD;  
    
     private static String DATAX_REMOTE_PATH = MonitorConfig.DATAX_REMOTE_PATH;
     
     private static String HADOOP_DFS_PATH = MonitorConfig.HADOOP_DFS_PATH;
     ...
     */
     ...
     public void truncateHiveHdfsRubish(String tableName,String schema){
    	 this.exec("hadoop fs -rmr .Trash/Current"+HADOOP_DFS_PATH+"/"+schema+".db/"+SyncCommUtil.trimTou(tableName));
     }
      ...
      * @param schema
      */
     public void truncateHiveTableData(String tableName,String schema,String[] partitions) {
    	 this.exec("hadoop fs -rm -r  "+HADOOP_DFS_PATH+"/"+schema+".db/"+SyncCommUtil.trimTou(tableName)+"/day="+partitions[0]+"/hour="+partitions[1]);
     }
     ...
     public boolean excuteDataxTransData(String jsonPath){
    	 return this.exec("python "+DATAX_REMOTE_PATH+" "+jsonPath) ;
     }
     ...
     public static void main(String[] args) {
    	 ...
    	 tool1.releaseConn();
    	 RemoteShellTool tool2 = RemoteShellTool.getInstance();
    	 tool2.excuteDataxTransData("ls -l");
	}
}
